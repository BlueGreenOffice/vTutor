...
namespace VTutor.Web.Controllers
{
  ...
  public class TutorSubjectsController : Controller
  {
    ...
    [HttpGet]
    public IEnumerable<TutorSubjects> GetTutorSubject()
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> PutTutorSubject([FromRoute] Guid id, [FromBody] TutorSubjects tutorSubject)
    {
      if (!ModelState.IsValid)
      {
        return BadRequest(ModelState);
    ...
    [HttpPost]
    public async Task<IActionResult> PostTutorSubject([FromBody] TutorSubjects tutorSubject)
    {
      if (!ModelState.IsValid)
      {
        return BadRequest(ModelState);
